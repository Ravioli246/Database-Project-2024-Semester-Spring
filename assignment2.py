...
with open('./datagen2/data/new/archives.csv', 'r') as archives_file:
...
with open('./datagen2/data/new/shelves.csv', 'r') as shelves_file:
...
with open('./datagen2/data/new/archival_assignments2.csv', 'w', newline='') as file:
